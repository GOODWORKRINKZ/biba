...
Статус: **импортировано из EasyEDA** — схема и плата в KiCad, связность
совпадает с исходником. Остались косметика шелкографии и доводка (см.
...
| `brushed-bts7960.kicad_sch` | схема: 68 компонентов, 58 цепей (импорт 1:1 = 57/56, плюс доработка ниже) |
| `brushed-bts7960.kicad_pcb` | плата 124.51 × 100.33 мм, 2 слоя, 539 дорожек, 51 via, 16 полигонов (пока без доработки) |
...
**На плату это ещё не перенесено.** Следующий шаг — в pcbnew «Обновить плату
из схемы», расставить новые посадочные места и развести. Места нужно
прилично: снабберные резисторы выводные 25×9 мм с шагом 30.5 мм, C14 — 16 мм
в диаметре, супрессоры DO-201AE. Ключевое в размещении — не длина дорожки до
клеммы, а близость к выводам: керамика вплотную к пинам 7 и 1 своего
драйвера, снабберы — к клеммам мотора.
...
1. **Перенести доработку на плату**: в pcbnew «Обновить плату из схемы»,
   разместить C10–C14, R27/C15, R28/C16, D1/D2 и развести. Критерий
   размещения — близость к выводам, а не к клемме (см. §5a анализа).
