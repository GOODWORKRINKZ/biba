...
1. Создать KiCad-проект `brushed-bts7960.kicad_pro` + пустую схему.
2. Отрисовать силовую часть: 24 В, 2×BTS7960, моторы, датчики, DC/DC.
3. Отрисовать логику: RP2040, CRSF, IMU, LED-панели.
4. ERC → затем плата.
