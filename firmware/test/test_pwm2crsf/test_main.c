...
static pwm2crsf_config_t make_config(void)
{
    ...
    cfg.cycle_input = PWM2CRSF_UNMAPPED;
    return cfg;
}
...
static pwm2crsf_config_t make_cycle_config(bool latching)
{
    ...
    cfg.cycle_input            = 3;   /* PWM4 */
    cfg.cycle_crsf_ch          = 5;   /* CH6  */
    cfg.cycle_steps            = 3;
    cfg.cycle_count_both_edges = latching;
    cfg.cycle_high_us          = 1700;
    cfg.cycle_low_us           = 1300;
    cfg.cycle_min_interval_us  = 150 * MS;
    return cfg;
}
