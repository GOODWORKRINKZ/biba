...
SPLIT_BLHELI_CATALOG: dict[str, tuple[str, str, int]] = {
    "biba_signature": (
        "B5 1/16 E6 1/16 E6 1/8 D6 1/8 A5 1/8",
        "G5 1/16 B5 1/16 B5 1/8 A5 1/8 E5 1/8",
        168,
    ),
    "startup": (
        "C5 1/16 E5 1/16 E5 1/8 D5 1/8 C5 1/8",
        "G4 1/16 C5 1/16 C5 1/8 B4 1/8 G4 1/8",
        150,
    ),
    "arm": (
        "C5 1/16 E5 1/16 G5 1/16 C6 1/8",
        "G4 1/16 C5 1/16 E5 1/16 G5 1/8",
        180,
    ),
    "disarm": (
        "G5 1/8 D5 1/4",
    ...
    "low_voltage": (
        "A5 1/8 P 1/16 A5 1/8 P 1/16 A5 1/8",
        "F5 1/8 P 1/16 F5 1/8 P 1/16 F5 1/8",
        160,
    ),
    "failsafe": (
        "D4 1/2",
    ...
    "sos": (
        "E6 1/16 E6 1/16 E6 1/16 P 1/8 E6 1/4 E6 1/4 E6 1/4 P 1/8 E6 1/16 E6 1/16 E6 1/16",
        "C6 1/16 C6 1/16 C6 1/16 P 1/8 C6 1/4 C6 1/4 C6 1/4 P 1/8 C6 1/16 C6 1/16 C6 1/16",
        100,
    ),
    "connected": (
        "E5 1/16 A5 1/16",
    ...
    "disconnected": (
        "E5 1/16 C5 1/8 A4 1/8",
        "C5 1/16 A4 1/8 E4 1/8",
        140,
    ),
    "shutdown": (
        "C5 1/8 D5 1/8 E5 1/16 C5 1/16 A4 1/4",
        "G4 1/8 A4 1/8 C5 1/16 A4 1/16 E4 1/4",
        140,
    ),
    "trim_enter": (
        "E5 1/16 G5 1/16 B5 1/8 C6 1/8",
