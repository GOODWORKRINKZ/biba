...
BTS7960_PWM_MODE = _get_env_choice("BTS7960_PWM_MODE", "SOFTWARE", {"HARDWARE", "SOFTWARE"})
...
LEFT_MOTOR_RPWM = _get_env_int("LEFT_MOTOR_RPWM", 12)
LEFT_MOTOR_LPWM = _get_env_int("LEFT_MOTOR_LPWM", 18)
...
RIGHT_MOTOR_RPWM = _get_env_int("RIGHT_MOTOR_RPWM", 19)
RIGHT_MOTOR_LPWM = _get_env_int("RIGHT_MOTOR_LPWM", 13)
...
MOTOR1_INVERTED = _get_env_int("MOTOR1_INVERTED", 1)
...
LEFT_MOTOR_CURRENT_SENSE_FORWARD_CHANNEL = _get_env_int("LEFT_MOTOR_CURRENT_SENSE_FORWARD_CHANNEL", 2)
LEFT_MOTOR_CURRENT_SENSE_REVERSE_CHANNEL = _get_env_int("LEFT_MOTOR_CURRENT_SENSE_REVERSE_CHANNEL", 3)
RIGHT_MOTOR_CURRENT_SENSE_FORWARD_CHANNEL = _get_env_int("RIGHT_MOTOR_CURRENT_SENSE_FORWARD_CHANNEL", 0)
RIGHT_MOTOR_CURRENT_SENSE_REVERSE_CHANNEL = _get_env_int("RIGHT_MOTOR_CURRENT_SENSE_REVERSE_CHANNEL", 1)
...
MOTOR_CURRENT_TRACE_ENABLED = bool(_get_env_int("MOTOR_CURRENT_TRACE_ENABLED", 0))
MOTOR_CURRENT_TRACE_PATH = os.getenv("MOTOR_CURRENT_TRACE_PATH", "/data/current-trace.jsonl")
MOTOR_CURRENT_TRACE_POST_ROLL_S = _get_env_float("MOTOR_CURRENT_TRACE_POST_ROLL_S", 2.0)
MOTOR_CURRENT_TRACE_MIN_INTERVAL_S = _get_env_float("MOTOR_CURRENT_TRACE_MIN_INTERVAL_S", 0.0)
...
BMS_TELEMETRY_TRACE_ENABLED = bool(_get_env_int("BMS_TELEMETRY_TRACE_ENABLED", 0))
...
CH_SPEED_MODE = _get_env_int("CH_SPEED_MODE", 5)
CH_DRIVE_MODE = _get_env_int("CH_DRIVE_MODE", 6)
...
SPEED_MODE_LOW_THRESHOLD = _get_env_float("SPEED_MODE_LOW_THRESHOLD", -0.3)
SPEED_MODE_HIGH_THRESHOLD = _get_env_float("SPEED_MODE_HIGH_THRESHOLD", 0.3)
SPEED_MODE_SLOW_SCALE = _get_env_float("SPEED_MODE_SLOW_SCALE", 1.0 / 3.0)
SPEED_MODE_MEDIUM_SCALE = _get_env_float("SPEED_MODE_MEDIUM_SCALE", 2.0 / 3.0)
SPEED_MODE_FAST_SCALE = _get_env_float("SPEED_MODE_FAST_SCALE", 1.0)
DRIVE_MODE_LOW_THRESHOLD = _get_env_float("DRIVE_MODE_LOW_THRESHOLD", -0.3)
DRIVE_MODE_HIGH_THRESHOLD = _get_env_float("DRIVE_MODE_HIGH_THRESHOLD", 0.3)
DRIVE_MODE_STEERING_DEADBAND = _get_env_float("DRIVE_MODE_STEERING_DEADBAND", 0.05)
DRIVE_MODE_STEERING_LIMIT = _get_env_float("DRIVE_MODE_STEERING_LIMIT", 1.0)
DRIVE_MODE_YAW_RATE_MAX_DPS = _get_env_float("DRIVE_MODE_YAW_RATE_MAX_DPS", 90.0)
DRIVE_MODE_YAW_RATE_KP = _get_env_float("DRIVE_MODE_YAW_RATE_KP", 0.01)
DRIVE_MODE_YAW_RATE_KI = _get_env_float("DRIVE_MODE_YAW_RATE_KI", 0.0)
DRIVE_MODE_YAW_RATE_KD = _get_env_float("DRIVE_MODE_YAW_RATE_KD", 0.001)
DRIVE_MODE_YAW_RATE_DEADBAND_DPS = _get_env_float("DRIVE_MODE_YAW_RATE_DEADBAND_DPS", 4.0)
DRIVE_MODE_YAW_RATE_FILTER_HZ = _get_env_float("DRIVE_MODE_YAW_RATE_FILTER_HZ", 5.0)
DRIVE_MODE_STABILIZATION_MIN_THROTTLE = _get_env_float("DRIVE_MODE_STABILIZATION_MIN_THROTTLE", 0.1)
DRIVE_MODE_NEUTRAL_STABILIZATION_STEERING_LIMIT = _get_env_float(
    "DRIVE_MODE_NEUTRAL_STABILIZATION_STEERING_LIMIT", 0.12
)
DRIVE_MODE_NEUTRAL_STABILIZATION_MAX_THROTTLE = _get_env_float(
    "DRIVE_MODE_NEUTRAL_STABILIZATION_MAX_THROTTLE", 0.25
)
IMU_ENABLED = bool(_get_env_int("IMU_ENABLED", 0))
IMU_I2C_BUS = _get_env_int("IMU_I2C_BUS", 1)
IMU_I2C_ADDRESS = _get_env_int("IMU_I2C_ADDRESS", 0x68)
IMU_EXPECTED_CHIP_ID = _get_env_int("IMU_EXPECTED_CHIP_ID", 0xD1)
IMU_SAMPLE_RATE_HZ = _get_env_float("IMU_SAMPLE_RATE_HZ", 100.0)
IMU_STALE_TIMEOUT_S = _get_env_float("IMU_STALE_TIMEOUT_S", 0.2)
IMU_GYRO_BIAS_CALIBRATION_S = _get_env_float("IMU_GYRO_BIAS_CALIBRATION_S", 1.0)
IMU_GYRO_Z_SIGN = _get_env_float("IMU_GYRO_Z_SIGN", 1.0)
...
CH_MUTE = _get_env_int("CH_MUTE", 9)
...
PID_TUNING_SETTINGS_PATH = os.getenv("PID_TUNING_SETTINGS_PATH", "/data/pid-tuning.json")
