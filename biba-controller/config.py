...
DRIVE_MODE_YAW_RATE_KP = _get_env_float("DRIVE_MODE_YAW_RATE_KP", 0.02)
DRIVE_MODE_YAW_RATE_KI = _get_env_float("DRIVE_MODE_YAW_RATE_KI", 0.0)
DRIVE_MODE_YAW_RATE_KD = _get_env_float("DRIVE_MODE_YAW_RATE_KD", 0.0)
...
HEADING_HOLD_KP = _get_env_float("HEADING_HOLD_KP", 2.0)
HEADING_HOLD_KI = _get_env_float("HEADING_HOLD_KI", 0.0)
HEADING_HOLD_KD = _get_env_float("HEADING_HOLD_KD", 0.0)
HEADING_HOLD_MAX_RATE_DPS = _get_env_float("HEADING_HOLD_MAX_RATE_DPS", 45.0)
