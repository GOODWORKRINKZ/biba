...
THROTTLE_FILTER_MODE = _get_env_choice("THROTTLE_FILTER_MODE", "KALMAN", {"NONE", "KALMAN"})
...
THROTTLE_REQUIRES_NEUTRAL_BEFORE_REVERSE = bool(
    _get_env_int("THROTTLE_REQUIRES_NEUTRAL_BEFORE_REVERSE", 1)
)
